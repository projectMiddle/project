...
public class ApprovalRepositoryTest {
        ...
        // // 결재 라인
        // // 결재 3인
        // Employee approver1 = employeeRepository.findById(1015L).orElseThrow(); //
        // AD_AM
        // Employee approver2 = employeeRepository.findById(1010L).orElseThrow(); //
        // ASSI_MGR
        // Employee approver3 = employeeRepository.findById(1007L).orElseThrow(); //
        // AD_MGR

        // // 참조 3인
        // Employee reference1 = employeeRepository.findById(1018L).orElseThrow(); //
        // AD_AM
        // Employee reference2 = employeeRepository.findById(1019L).orElseThrow(); //
        // AD_AM
