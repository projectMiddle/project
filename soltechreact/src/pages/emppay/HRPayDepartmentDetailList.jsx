...
const HRPayDepartmentDetailList = () => {
      ...
      getEmployeesByDepartment(deptNo)
        .then((data) => {
          ...
          const sortedData = data.sort((a, b) => {
            return (rankPriority[a.jobName] || 999) - (rankPriority[b.jobName] || 999);
          });
  ...
  return (
    <div>
      <div className="bg-[#6b46c1]">
        <h1 className="ml-10 text-white font-bold text-[20px] text-left py-[14px]">부서별 사원</h1>
      </div>
      <div className="p-7 bg-white m-6 rounded-xl">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {employees.map((emp) => (
            <div key={emp.empNo} className="bg-white border border-gray-100 rounded-xl p-4 shadow-sm">
              ...
              <div className="bg-purple-50/95 mt-2.5 p-3 rounded-xl">
                ...
                <div className="flex gap-2 mt-4">
                  ...
                  <button
                    ...
                    onClick={() =>
                      navigate(
                        `/intrasoltech/emppay/HRPayDepartmentList/HRPayDepartmentDetailList/${deptNo}/employees/${emp.empNo}/pay`
                      )
                    }
                  >
                    급여명세서
...
export default HRPayDepartmentDetailList;
