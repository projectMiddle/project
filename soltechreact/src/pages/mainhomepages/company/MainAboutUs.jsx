    ...
    <div className="bg-white text-gray-800 font-[Pretendard]">
      ...
      <section className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 px-4 pb-20">
        {[
          {
            title: "출결 관리",
            desc: "로그인/로그아웃 시 자동 출퇴근 기록",
            img: "/mainImages/aboutUs/about_us_Attendance.png",
          },
          { title: "공지사항", desc: "AD 이상 직급이 공지 작성 가능", img: "/mainImages/aboutUs/about_us_Notify.png" },
          {
            title: "일정 관리",
            desc: "개인/부서 일정 달력으로 확인",
            img: "/mainImages/aboutUs/about_us_Calendar.png",
          },
          ...
          <div
            key={idx}
            className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition text-left"
          >
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 leading-relaxed text-sm md:text-base">
              이번 프로젝트의 모든 기능은 제가 학습한 기술들과 실제 실무 환경에서 자주 쓰이는 구성 방식을 토대로
              설계되었습니다.
              <br className="hidden md:block" />
              <br className="hidden md:block" />
              출결, 공지, 결재, 메일, 일정, 급여 등 각각의 기능은 단순한 기능 구현을 넘어서 데이터 흐름과 사용자
              경험(UX)을 고려한 구조로 연결되며, Spring Boot + JPA + Oracle DB + React + TailwindCSS 조합의 전형적인
              엔터프라이즈 개발 패턴을 따르고 있습니다.
              <br className="hidden md:block" />
              <br className="hidden md:block" />
              지금까지 학습한 ORM 설계, 정규화, 프론트-백 연동, 보안 개념, 화면 흐름 설계까지 모두 녹여낸 결과물입니다.
            </p>
            <a
              href="https://www.notion.so/211f85a884ab81d7b34df550843efa60?v=211f85a884ab8170b1a8000c8a5f1c7a"
              target="_blank"
      ...
      <section className="bg-gray-50 py-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-gray-600 max-w-3xl mx-auto leading-relaxed">
            다양한 도구와 환경을 조합하여 개발했습니다. 팀 간 협업은 GitHub와 Discord를 중심으로 진행하였고, UI 디자인은
            Figma, Storyset, API 연동은 Google API를 활용하였습니다. 모든 개발은 Visual Studio Code, DBeaver, Git,
            Postman을 활용해 체계적으로 구성했습니다.
          </p>
      ...
      <section className="bg-white py-20 px-4">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 leading-relaxed text-sm md:text-base">
              기업 내부의 행정·출결·결재·소통 시스템을 하나로 통합하고 싶었습니다. 복잡하게 흩어져 있던 일정 관리, 공지,
              출퇴근 기록, 급여 계산, 문서 결재, 사내메일 등을 한 플랫폼 안에서 직관적으로 관리할 수 있도록
              설계했습니다.
              <br className="hidden md:block" />
              <br className="hidden md:block" />
              모든 기능은 사용자 중심의 흐름으로 연결되며, 관리자와 일반 사용자 모두가 쉽게 접근하고 활용할 수 있도록
              UX/UI에 세심하게 신경을 썼습니다. 실무를 고려한 데이터베이스 설계와 간결한 구조는 유지보수에도 강점을
              가집니다.
            </p>
      ...
      <section className="bg-white py-16 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
              <img
                src="/mainImages/aboutUs/about_us_Product_iteration.png"
                alt="전자결재"
                className="h-20 mx-auto mb-3"
              />
              <h3 className="font-semibold text-gray-800 mb-2">효율적인 승인 체계</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
                전자결재를 통해 승인 과정을 빠르고 명확하게 처리해요.
              </p>
            </div>
          </div>
        </div>
